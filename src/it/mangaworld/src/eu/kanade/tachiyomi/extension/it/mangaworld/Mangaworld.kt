...
class Mangaworld : ParsedHttpSource() {
    ...
    override fun mangaDetailsParse(document: Document): SManga {
        ...
        val manga = SManga.create()
        manga.author = infoElement.select("a[href^=https://www.mangaworld.in/archive?author=]").first()?.text()
        manga.artist = infoElement.select("a[href^=https://www.mangaworld.in/archive?artist=]")?.text()
        ...
        manga.status = parseStatus(infoElement.select("a[href^=https://www.mangaworld.in/archive?status=]").first().attr("href"))
